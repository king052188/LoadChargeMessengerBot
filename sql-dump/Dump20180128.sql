...
--
-- Table structure for table `tbl_load_commands`
--

DROP TABLE IF EXISTS `tbl_load_commands`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tbl_load_commands` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `custom_cmd` varchar(50) DEFAULT NULL,
...
-- Dump completed on 2018-01-28 21:29:48
